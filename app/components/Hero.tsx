      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-20">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="flex-1 text-center lg:text-left">
            {/* Badge */}
            <div
              className={`inline-flex items-center gap-2 glass-purple px-4 py-2 rounded-full mb-8 transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}
            >
          ...
          >
            <div className="relative w-72 h-72 lg:w-96 lg:h-96">
              ...
              {/* Speed badge */}
              <div className="absolute -bottom-4 -right-4 glass-purple px-4 py-2.5 rounded-2xl animate-float">
                <div className="text-xs text-brand-light font-medium">Kecepatan hingga</div>
                <div className="font-display font-800 text-2xl gradient-text-green">1 Gbps</div>
              </div>

              {/* Status badge */}
              <div className="absolute -top-2 -left-2 glass-purple px-3 py-2 rounded-xl animate-float-delayed flex items-center gap-2">
                <span className="w-2 h-2 bg-neon-green rounded-full animate-pulse" />
                <span className="text-xs font-semibold text-white">Online 24/7</span>
              </div>
            </div>
          </div>
        </div>
